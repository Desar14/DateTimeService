...
namespace DateTimeService.Controllers
{
    ...
    public class DateTimeController : ControllerBase
    {
        ...
        public async Task<ObjectResult> PostAsync(IEnumerable<RequestData> nomenclatures)
        {
            ...
            string connString = @"Server=tcp:192.168.1.14;Database=triovist;Uid=sa;Pwd=1q2w3e!; Trusted_Connection = False;";

            //string connString = @"Server=localhost;Database=DevBase_cut_v3;Uid=sa;Pwd=DesarIstheBest111; Trusted_Connection = False;";
