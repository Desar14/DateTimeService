...
exec sp_addpushsubscription_agent @publication = @publ_name, @subscriber = @subscr_server, @subscriber_db = @subscr_db, @job_login = @login, @job_password = @pass, @subscriber_security_mode = 0, @subscriber_login = N'netms', @subscriber_password = N'uwl~C0ye8W', @frequency_type = 64, @frequency_interval = 1, @frequency_relative_interval = 1, @frequency_recurrence_factor = 0, @frequency_subday = 4, @frequency_subday_interval = 5, @active_start_time_of_day = 0, @active_end_time_of_day = 235959, @active_start_date = 0, @active_end_date = 0, @dts_package_location = N'Distributor'
--GO
...
exec sp_addpushsubscription_agent @publication = @publ_name, @subscriber = N'SERVER-1C-SQL-1', @subscriber_db = N'triovist_repl', @job_login = @login, @job_password = @pass, @subscriber_security_mode = 0, @subscriber_login = N'netms', @subscriber_password = N'uwl~C0ye8W', @frequency_type = 64, @frequency_interval = 1, @frequency_relative_interval = 1, @frequency_recurrence_factor = 0, @frequency_subday = 4, @frequency_subday_interval = 5, @active_start_time_of_day = 0, @active_end_time_of_day = 235959, @active_start_date = 0, @active_end_date = 0, @dts_package_location = N'Distributor'
GO
